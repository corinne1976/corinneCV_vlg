...
if(isset($_POST['f_titre'])){ // Si on a posté une nouvelle compétence
    if(!empty($_POST['f_titre'])){ // Si compétence n'est pas vide
        ...
        $pdoCV -> exec("INSERT INTO t_formations (id_formation, loisir, utilisateur_id) VALUES (NULL, '$loisir', '1')"); // mettre $id_utilisateur quand on l'aura dans la variable de session
...
if(isset($_GET['id_loisir'])){ // on récupère la compétence par son ID danhs l'url
